...
class DataTrainingArguments:
    ...
    local_dataset_dir: str = field(
        default=None, metadata={"help": "The local audiofolder directory of the dataset to use (via the datasets library)."}
    )
...
def main():
    ...
    if training_args.do_train:
        if data_args.local_dataset_dir:
            raw_datasets["train"] = load_dataset(
                "audiofolder", 
                data_dir=data_args.local_dataset_dir,
